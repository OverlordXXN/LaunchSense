...
def main():
    ...
    logger.info("Initializing Logistic Regression model (max_iter=1000)...")
    ...
    model_path = os.path.join(models_dir, 'kickstarter_success_model.pkl')
    
    logger.info(f"Saving trained model to {model_path}...")
    joblib.dump(model, model_path)
    
    print(f"\nModel successfully saved to: models/kickstarter_success_model.pkl")
